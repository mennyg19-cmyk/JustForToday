  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Modal surfaces: always opaque, used for modal content and borders
        ...
        'progress-fill': 'rgb(var(--progress-fill) / <alpha-value>)',
      ...
      boxShadow: {
        ...
        'card-lg': '0 2px 8px rgba(0, 0, 0, 0.1)',
