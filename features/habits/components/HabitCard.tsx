    ...
    <>
      ...
      <View className="flex-row items-start justify-between mb-2">
        <View className="flex-1 pr-1">
          <Text className="text-sm font-bold text-card-foreground" numberOfLines={2}>
            {habit.name}
          </Text>
          {/* Type badge */}
          {habit.type === 'break' ? (
            <View className="bg-destructive/20 px-1.5 py-0.5 rounded mt-1 self-start">
              <Text className="text-destructive text-[9px] font-bold">BREAK</Text>
            </View>
          ) : (
            <View className="bg-primary/20 px-1.5 py-0.5 rounded mt-1 self-start">
              <Text className="text-primary text-[9px] font-bold">BUILD</Text>
            </View>
          )}
        </View>
        <TouchableOpacity
