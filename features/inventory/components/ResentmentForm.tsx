/**
 * ResentmentForm — Step 10 resentment / spot-check inventory form.
 *
 * Extracted from InventoryScreen to keep the main screen lean.
 * Contains all form state, validation, save/edit/delete logic,
 * the 7th-step prayer, and the saved-entries list.
 */
...
/* ─── privacy lock shape (matches SavedSection) ─── */
...
/* ─── props ─── */
export interface ResentmentFormProps {
