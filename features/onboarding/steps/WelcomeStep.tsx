...
export function WelcomeStep({ onNext, onBack, onSkip }: StepProps) {
  const iconColors = useIconColors();

  return (
    <OnboardingStep onNext={onNext} onBack={onBack} onSkip={onSkip} nextLabel="Let's Begin" showSkip={false}>
