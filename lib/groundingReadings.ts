...
export const DEFAULT_READINGS: GroundingReading[] = [
  {
    ...
    uri: 'https://www.aa.org/the-big-book',
    isDefault: true,
    visible: true,
    type: 'url',
  },
  {
    ...
    subtitle: 'AA 12&12',
    uri: 'https://www.aa.org/twelve-steps-twelve-traditions',
    isDefault: true,
    visible: true,
    type: 'url',
  },
  {
    ...
    uri: 'https://na.org/products/basic-text/',
    isDefault: true,
    visible: true,
    type: 'url',
  },
  {
    id: 'default_daily_reflections',
    title: 'Daily Reflections',
    subtitle: 'AA daily meditation',
    uri: 'https://www.aa.org/daily-reflections',
    isDefault: true,
    visible: true,
    type: 'url',
  },
